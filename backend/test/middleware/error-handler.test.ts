...
describe('Global Error Handler', () => {
  ...
  describe('sanitizeTechnicalMessage pattern coverage', () => {
    ...
    it('should redact connection strings', () => {
      expect(sanitizeTechnicalMessage('Cannot connect to postgresql://admin:password123@localhost:5432/recoveriq')).toBe(
    ...
    it('should redact absolute file paths (Unix and Windows)', () => {
      ...
      expect(sanitizeTechnicalMessage('Exception in C:\\Users\\sures\\Desktop\\RecoverIQ\\backend\\src\\index.ts')).toBe(
    ...
    it('should redact internal hostnames and URLs', () => {
      ...
      expect(sanitizeTechnicalMessage('Host recoveriq.internal cannot be resolved')).toBe(
