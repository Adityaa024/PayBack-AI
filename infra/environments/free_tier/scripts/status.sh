...
echo -e "\033[1;36m          RECOVERIQ FREE-TIER INFRASTRUCTURE STATUS        \033[0m"
echo -e "\033[1;36m========================================================\033[0m"
echo ""

cd "${ENV_DIR}"

FRONTEND_URL=$(terraform output -raw frontend_url 2>/dev/null || echo "https://recoveriq-frontend.vercel.app")
BACKEND_URL=$(terraform output -raw backend_url 2>/dev/null || echo "https://recoveriq-backend.onrender.com")
AI_URL=$(terraform output -raw ai_service_url 2>/dev/null || echo "https://recoveriq-ai-service.onrender.com")
