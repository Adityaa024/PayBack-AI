...
module "secrets_dev" {
  ...
  platform_from_email           = try(local.secrets_dev.platform_from_email, "no-reply@recoveriq.site")
  platform_from_name            = try(local.secrets_dev.platform_from_name, "RecoverIQ")
...
module "secrets_production" {
  ...
  platform_from_email           = try(local.secrets_prod.platform_from_email, "no-reply@recoveriq.site")
  platform_from_name            = try(local.secrets_prod.platform_from_name, "RecoverIQ")
