            ...
            <div>
              ...
              <p className="text-[#f7f8f8] font-medium mt-0.5">
                {s.replyMode === 'real_mailbox' ? (
                  ...
                  <span className="text-[#8a8f98]">Disabled (Managed inside RecoverIQ AI & Timeline)</span>
                )}
              </p>
            </div>
            {s.replyMode === 'real_mailbox' && (
        ...
        <label className="flex items-start space-x-2.5 cursor-pointer">
          ...
          <div>
            ...
            <span className="text-[11px] text-[#8a8f98] block leading-normal mt-0.5">
              When checked, customer replies logged in RecoverIQ AI will also be forwarded to your specified receiving mailbox.
            </span>
          </div>
        </label>
