            ...
            <form onSubmit={handleCredentialsSubmit} className="space-y-5">
              ...
              <div className="pt-1">
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-cyan-500/20 via-emerald-500/20 to-violet-500/20 hover:from-cyan-500/30 hover:to-violet-500/30 border border-cyan-500/30 text-cyan-300 font-semibold text-xs flex items-center justify-center gap-2 transition-all shadow-sm cursor-pointer"
                >
