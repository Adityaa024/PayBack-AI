    ...
    <div className="space-y-6 text-[#f7f8f8]">
      <Card className="border border-[#23252a] bg-[#0f1011] rounded-2xl">
        ...
        <CardContent className="space-y-5 pt-5">
          ...
          {/* Section 4: Hackathon Demo Reset */}
          <div className="p-4 border border-red-900/30 rounded-xl bg-red-950/10 space-y-4">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex-1 min-w-0">
                <h4 className="text-xs font-bold text-red-400 flex items-center">
                  <Trash2 className="w-3.5 h-3.5 mr-1.5 text-red-400" />
                  Hackathon Demo Data Reset
                </h4>
                <p className="text-[11px] text-[#8a8f98] mt-0.5 leading-relaxed">
                  Permanently erase all seeded recovery sessions, audits, and signals for a clean demo slate.
                </p>
              </div>
              <button
                type="button"
                onClick={async () => {
                  if (confirm('Are you sure you want to permanently erase all demo data? This cannot be undone.')) {
                    try {
                ...
                className="px-4 py-2 bg-red-500/10 text-red-400 hover:bg-red-500/20 border border-red-500/30 rounded-xl text-xs font-bold transition-all flex items-center cursor-pointer shadow-sm"
              >
                Reset Demo Data
              </button>
            </div>
...
function SupportSection() {
  ...
  const supportEmail = "support@recoveriq.site";
